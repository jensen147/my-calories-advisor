...
public class SignUpGoal extends AppCompatActivity {
    ...
    public void signUpGoalSubmit() {
        ...
        if(errorMessage.isEmpty()){
            Intent i = new Intent(SignUpGoal.this, EditProfileGoal.class);
            i.putExtra("targetweight",stringTargetWeight);
            i.putExtra("targetweightweek",stringWeeklyGoal);
            startActivity(i);
        }
